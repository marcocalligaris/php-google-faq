...
$faq_sections = [
    ...
    [
        ...
        'paragraph' => [
            'text' => 
                ...
                <ol class="mb-4">
                    <li class="mb-4">La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
    ...
    [
        'title' => '',
        'second_title' => 'Stabilire il paese associato al tuo account',
        'paragraph' => [
            'text' => 
                ...
                <p>Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l\'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. <a href="https://policies.google.com/country-association-form">Contattaci <i class="fa-solid fa-arrow-up-right-from-square"></i></a> se ritieni che il paese associato al tuo account sia sbagliato.</p>',
        ],
    ],
    [
            ...
            <section>
                <?php foreach ($faq_sections as $section) : ?>
                    <div class="mb-5">
                        ...
                        <h4 class="mb-4"><?php echo $section['second_title'] ?></h4>
                        <p><?php echo $section['paragraph']['text'] ?></p>
                    </div>
                <?php endforeach; ?>
            </section>
        </div>
